...
/*                             External Functions                             */
/*----------------------------------------------------------------------------*/
void* wifi_helper_convert( const void *buf, size_t len,
    ...
    else
    {
	    ...
	    msgpack_object_print(stdout, obj);
		    ...
		    wifi_private_security_5g =  __finder( "private_security_5g", expect_type, &msg.data.via.map );
                    ...
                    printf("private_ssid_5g is %ld\n", (size_t)wifi_private_ssid);
                    printf("private_security_2g is %ld\n", (size_t)wifi_private_security_2g);
		    printf("private_security_5g is %ld\n", (size_t)wifi_private_security_5g);
                                       
                    if( ((NULL != inner) && (0 == (process)(p,4, inner, wifi_private_ssid, wifi_private_security_2g,private_security_5g))) || 
